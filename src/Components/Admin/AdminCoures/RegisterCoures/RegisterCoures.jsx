...
const [btn, setBtn] = useState(false)
  ...
  useEffect(()=>{
    khoaHocServ.hocVienKhoaHoc(id).then((res)=>{
      console.log(res)
    ...
    className="detailsItemRight w-1/3">
      <div className="itemRightSidebar">
        ...
        <div className="sidebarContent">
          ...
          <button disabled={btn} type="submit" className={`btnSidebar w-full rounded-lg p-3 ${btn ? 'opacity-60' : 'hover:opacity-75'}`}>Ghi danh</button>
